...
SHLIB_LINK  += $(CH_LIBS) -lstdc++ $(shell pkg-config --libs --cflags icu-uc icu-io) -lanl -lodbc $(shell mysql_config --libs) -lssl -lcrypto -lreadline $(CH_LIBS) 
